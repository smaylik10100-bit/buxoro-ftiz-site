...
export default function BukharaTBClinicSite() {
  ...
  return (
    <div className="min-h-screen text-gray-900">
          ...
          <div className="flex items-center justify-between h-24 gap-4">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="leading-tight min-w-0">
                <div className="font-extrabold text-[clamp(1.1rem,2.2vw,1.75rem)] leading-snug break-words">
                  {t.header.title}
                </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="hidden sm:inline-flex items-center gap-2 rounded-2xl bg-teal-600 text-white px-4 py-2.5 text-base hover:bg-teal-700"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              {t.hero.extra && (
                <p className="mt-4 text-gray-700 text-sm sm:text-base">{t.hero.extra}</p>
              )}
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-2xl bg-teal-600 text-white px-4 py-2.5 text-base font-medium hover:bg-teal-700"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-2xl border px-4 py-2.5 text-base font-medium hover:bg-teal-50"
                >
      ...
      {/* Departments Section (оставим как пример видимой секции) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {t.departments.items.map((x, i) => (
              <div key={i} className="card-elev px-4 py-3 text-sm">
                {x}
              </div>
            ))}
          </div>
...
function IconTelegram({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M22 3L2.6 10.1c-.9.3-.9 1.1-.2 1.4l5 1.6 1.9 5.9c.2.5.8.6 1.2.2l2.8-2.3 4.7 3.5c.5.3 1.1.1 1.2-.5L23 3.8c.2-.8-.4-1.2-1-.8zM8 13l10-6-7.4 8.1-.3 3-2.3-5.1z" />
    </svg>
  );
}
